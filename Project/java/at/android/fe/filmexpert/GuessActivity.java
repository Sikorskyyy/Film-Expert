...
//    private Typeface typefaceTitleText = Typeface.createFromAsset(this.getAssets(),"fonts/RobotoCondensed-Bold.ttf");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(at.android.fe.filmexpert.R.layout.activity_guess);
        ...
        if (DataHandler.getInstance().getMovieArraySize() == 0) {
            ...
            textView = (TextView) findViewById(at.android.fe.filmexpert.R.id.guessTextView);
            ...
            gridview = (GridView) findViewById(at.android.fe.filmexpert.R.id.buttonLayout);
            gridview.setVisibility(View.INVISIBLE);

            nextButton = (Button) findViewById(at.android.fe.filmexpert.R.id.button2);
            nextButton.setEnabled(false);

            updateHearts(this);

            imageView = (ImageView) findViewById(at.android.fe.filmexpert.R.id.imageView);
            progressBar = (ProgressBar) findViewById(at.android.fe.filmexpert.R.id.progressBar);
            showImage();
        }
    }
    ...
    public void resetButtonClicked(View view) {
        guessTV = (TextView) findViewById(at.android.fe.filmexpert.R.id.guessTextView);
        guessTV.setText(at.android.fe.filmexpert.R.string.defaultText);
    ...
    private class DownloadImageTask extends AsyncTask<String,Void,Bitmap> {
        ...
        protected void onPostExecute(Bitmap bitmap) {
            ...
            textView.setText(getString(at.android.fe.filmexpert.R.string.defaultText));
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            myButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (textView.getText().equals(getString(at.android.fe.filmexpert.R.string.defaultText)))
    ...
    private void updateHearts(Context mContext) {
        switch(DataHandler.getInstance().getLives()) {
            case 0:
                ImageView iv1 = (ImageView) findViewById(at.android.fe.filmexpert.R.id.imageView1);
                iv1.setVisibility(View.INVISIBLE);
            case 1:
                ImageView iv2 = (ImageView) findViewById(at.android.fe.filmexpert.R.id.imageView2);
                iv2.setVisibility(View.INVISIBLE);
            case 2:
                ImageView iv3 = (ImageView) findViewById(at.android.fe.filmexpert.R.id.imageView3);
