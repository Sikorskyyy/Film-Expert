...
public class MainActivity extends AppCompatActivity implements OnFetchDataCompleted{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(at.android.fe.filmexpert.R.layout.activity_main);
        Toolbar toolbar = (Toolbar) findViewById(at.android.fe.filmexpert.R.id.toolbar);
        setSupportActionBar(toolbar);
        //material design fonts
        Typeface typefaceRobotoCondensedRegular = Typeface.createFromAsset(getAssets(),"fonts/RobotoCondensed-Regular.ttf");

        TextView appTitle = (TextView) findViewById(at.android.fe.filmexpert.R.id.textView);
        appTitle.setTypeface(typefaceRobotoCondensedRegular);
        appTitle.setTextColor(Color.parseColor("#000000"));
        appTitle.setTextSize(36);


        PreferenceManager.setDefaultValues(this, at.android.fe.filmexpert.R.xml.application_preferences, false);
    ...
    protected void onResume() {
        ...
        if (DataHandler.getInstance().getLives() <= 0) {
            Button resumeButton = (Button) findViewById(at.android.fe.filmexpert.R.id.buttonResume);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(at.android.fe.filmexpert.R.menu.menu_main, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            case at.android.fe.filmexpert.R.id.action_settings:
                Intent i = new Intent(this, SettingsActivity.class);
                startActivityForResult(i, SHOW_PREFERENCES);
                return true;
            case at.android.fe.filmexpert.R.id.action_about:
