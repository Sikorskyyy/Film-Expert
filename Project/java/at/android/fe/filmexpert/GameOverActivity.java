...
public class GameOverActivity extends AppCompatActivity implements OnFetchDataCompleted{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(at.android.fe.filmexpert.R.layout.activity_game_over);
        //Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        //setSupportActionBar(toolbar);

        TextView gameOverTitle = (TextView) findViewById(at.android.fe.filmexpert.R.id.gamOverTitle);
        Typeface tempTypeface = Typeface.createFromAsset(getAssets(), "fonts/Roboto-Medium.ttf");
        gameOverTitle.setTypeface(tempTypeface);

        TextView gameOverText1 = (TextView) findViewById(at.android.fe.filmexpert.R.id.gameOverText1);
        tempTypeface = Typeface.createFromAsset(getAssets(), "fonts/Roboto-Regular.ttf");
        gameOverText1.setTypeface(tempTypeface);

        TextView gameOverText = (TextView) findViewById(at.android.fe.filmexpert.R.id.gameOverText);
